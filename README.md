...
* [Valid Parentheses](stacks/07-valid-parentheses.md)

## Linked Lists

* [Reverse Linked List](linked-lists/08-reverse-linked-list.md)

## Progress Tracker

See [PROGRESS.md](PROGRESS.md) for the complete practice log.
